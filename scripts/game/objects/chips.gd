...
@onready var red_chip = preload("res://assets/models/chips_fixed/red_white.tscn") #5
@onready var green_chip = preload("res://assets/models/chips_fixed/green_white.tscn") #25
@onready var black_chip = preload("res://assets/models/chips_fixed/black_white.tscn") #100
@onready var blue_chip = preload("res://assets/models/chips_fixed/blue_white.tscn") #500
var chip_models = [
white_chip,
red_chip,
green_chip,
